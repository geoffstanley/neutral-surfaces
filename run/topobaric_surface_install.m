function topobaric_surface_install()
%TOPOBARIC_SURFACE_INSTALL  Handle Java, MEX, path, and data installation
% steps for Topobaric Surface. 
%
...
reply = input('* Do you want to download data used by the scripts in this folder? [Y/n]: ', 's');
if isempty(reply) || lower(reply(1)) == 'y'
