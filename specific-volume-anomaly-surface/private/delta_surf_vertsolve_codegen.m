function delta_surf_vertsolve_codegen(nk, ni, nj, Pvec, OPTS)
...
% specifies that P in delta_surf_vertsolv.m is just a vector: P(k) specifies
...
try
    ...
    if BUILD
        ...
        args = {t_Sppc, t_Sppc, t_P, t_BotK, t_p, 0, 0, 0, 0};
