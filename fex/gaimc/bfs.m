...
% Geoff J. Stanley modified one line, marked GJS below. 

%if ~exist('target','var') || isempty(full), target=0; end % DFG original 
if nargin < 3 || isempty(target), target = 0; end % GJS modified
