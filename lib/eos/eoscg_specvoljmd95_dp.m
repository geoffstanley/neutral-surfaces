function nu_p = eoscg_specvoljmd95_dp(s,t,p) %#ok<FNDEF> %#codegen
%EOSCG_SPECVOLJMD95_DP  Fast derivative of the JMD95 specific volume w.r.t pressure.
%
%
% nu_p = eoscg_specvoljmd95_dp(s,t,p)                   [ m^3 / (dbar kg) ]
