function specvol = eoscg_gsw_specvol_v304(SA,CT,p) %#ok<FNDEF> %#codegen
%EOSCG_GSW_SPECVOL  Fast GSW specific volume. 
%
%
% specvol = eoscg_gsw_specvol_v304(SA,CT,p)                    [ m^3 / kg ]
% computes the GSW v3.04 specific volume given Absolute Salinity SA,
...
%
% The inputs' and outputs' units are as in gsw_specvol, documented below.
% 
