function rho = eoscg_densmjwf2003_d2001(s, t, z) %#ok<FNDEF> %#codegen
%EOSCG_DENSMJWF2003_D2001  The McDougall, Jackett, Wright, and Feistel
% (2003) equation of state, with the Dukowicz (2001) Boussinesq correction.
%
%
% r = eoscg_densmjwf2003_d2001(s,t,z)                          [ kg / m^3 ]
% computes the D01 Boussinesq version of the MJWF03 in-situ density given
% practical salinity s, potential temperature t, and depth z.
%
%
% --- Input:
...
% The state_mod.F90 FORTRAN function reports the following test value: 
% rho = 1.033213242 for s = 35.0 PSU, theta = 20.0, pressz = 200.0
% Note that this MATLAB function has a slightly different test value:
% rho = 1.033213387 for s = 35.0 PSU, theta = 20.0, pressz = 200.0
% The relative error is about 1.4e-7, so this is likely just single vs
% double precision.

% The following FORTRAN code from state_mod.F90  is missing from this
% MATLAB function, because the values for tmin, tmax, smin, and smax are
