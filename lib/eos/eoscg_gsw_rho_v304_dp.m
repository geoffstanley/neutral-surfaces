function drho_dp = eoscg_gsw_rho_v304_dp(SA,CT,p)  %#ok<FNDEF> %#codegen
%EOSCG_GSW_RHO_DP  Fast derivative of the GSW in-situ density w.r.t. pressure.
%
%
% drho_dp = eoscg_gsw_rho_v304_dp(SA,CT,p)              [ kg / (dbar m^3) ]
% computes the partial derivative of the GSW v3.04 in-situ density with
% respect to pressure, given Absolute Salinity SA, Conservative Temperature
% CT, and pressure p.
%
%
