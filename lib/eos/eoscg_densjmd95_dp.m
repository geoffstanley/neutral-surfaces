function rho_p = eoscg_densjmd95_dp(s,t,p) %#ok<FNDEF> %#codegen
%EOSCG_DENSJMD95_DP  Fast derivative of the JMD95 in-situ density w.r.t pressure. 
%
%
% rho_p = eoscg_densjmd95_dp(s,t,p)                     [ kg / (dbar m^3) ]
