function v_P = eoscg_gsw_specvol_dp(SA,CT,p) %#ok<FNDEF> %#codegen
%EOSCG_GSW_SPECVOL_DP  Fast pressure derivative of the GSW specific volume.
%
%
% v_P = eoscg_gsw_specvol_dp(SA,CT,p)                   [ m^3 / (dbar kg) ]
...
%
%
% This function is derived from gsw_specvol_first_derivatives.m,
...
v_P = 1e-4.*v_p_part; % Original GSW code used 1e-8, for units of [m^3 kg^-1 Pa^-1]
