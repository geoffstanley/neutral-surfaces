function rho = eoscg_gsw_rho_bsq(SA,CT,z) %#ok<FNDEF> %#codegen
%EOSCG_GSW_RHO_BSQ  Fast Boussinesq GSW in-situ density.
%
%
% rho = eoscg_gsw_rho_bsq(SA,CT,z)                              [ kg / m^3 ]
% computes the Boussinesq GSW in-situ density given Absolute Salinity SA, Conservative
% Temperature CT, and depth z [m, positive and increasing down].  The depth
...
%
%
% This function is derived from gsw_rho.m, documented below. Input checks
% and expansion of variables have been removed; instead automatic expansion
% (requiring MATLAB 2016b or later) is used. This function is compatible
% with MATLAB's codegen.
%
% The inputs' and outputs' units are as in gsw_rho, documented below.
% 
