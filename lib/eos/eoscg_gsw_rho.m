function rho = eoscg_gsw_rho(SA,CT,p) %#ok<FNDEF> %#codegen
%EOSCG_GSW_RHO  Fast GSW in-situ density.
%
%
% rho = eoscg_gsw_rho(SA,CT,p)                                 [ kg / m^3 ]
% computes the GSW in-situ density given Absolute Salinity SA, Conservative
