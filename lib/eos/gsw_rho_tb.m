function rho = gsw_rho_tb(SA,CT,p) %#ok<FNDEF> %#codegen
%GSW_RHO_TB  Fast GSW in-situ density.
%
%
% rho = gsw_rho_tb(SA,CT,p)                                    [ kg / m^3 ]
% computes the GSW in-situ density given Absolute Salinity SA, Conservative
% Temperature CT, and pressure p.
%
%
% gsw_rho_tb is derived from gsw_rho.m, documented below. Input checks
...
%
% The inputs' and output's units are as in gsw_rho, documented below.
% 
