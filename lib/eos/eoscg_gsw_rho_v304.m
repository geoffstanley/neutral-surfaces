function rho = eoscg_gsw_rho_v304(SA,CT,p) %#ok<FNDEF> %#codegen
%EOSCG_GSW_RHO  Fast GSW in-situ density.
%
%
% rho = eoscg_gsw_rho_v304(SA,CT,p)                            [ kg / m^3 ]
% computes the GSW v3.04 in-situ density given Absolute Salinity SA,
% Conservative Temperature CT, and pressure p.
%
%
