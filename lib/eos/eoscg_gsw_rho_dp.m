function rho_P = eoscg_gsw_rho_dp(SA,CT,p)  %#ok<FNDEF> %#codegen
%EOSCG_GSW_RHO_DP  Fast derivative of the GSW in-situ density w.r.t. pressure.
%
%
% rho_P = eoscg_gsw_rho_dp(SA,CT,p)                     [ kg / (dbar m^3) ]
...
rho_P = -rho2.*Pa2db.*v_p; % Original had extra 1e-4 factor for per Pa
