function [v_SA, v_CT] = eoscg_gsw_specvol_bsq_s_t(SA,CT,z) %#ok<FNDEF> %#codegen
%EOSCG_GSW_SPECVOL_BSQ_S_T  Fast Boussinesq partial SA and CT derivatives of GSW specific volume. 
%
%
% [v_SA, v_CT] = eoscg_gsw_specvol_bsq_s_t(SA,CT,p)
...
% and depth z [m, positive and increasing down].  The depth z is converted
% into hydrostatic pressure for a given gravitational acceleration and
% Boussinesq reference density, which are hard-coded into this function
% (edit variables grav and rhob as needed).
%
%
